...
/**
 * DolniOdkazy form base class.
 *
 * @method DolniOdkazy getObject() Returns the current form's model object
 *
 * @package    caitalia
 * @subpackage form
 ...
 */
abstract class BaseDolniOdkazyForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dolni_odkazy[%s]');
