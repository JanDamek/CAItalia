...
/**
 * GalleryImage filter form base class.
 *
 * @package    caitalia
 * @subpackage filter
 ...
 */
abstract class BaseGalleryImageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('gallery_image_filters[%s]');
