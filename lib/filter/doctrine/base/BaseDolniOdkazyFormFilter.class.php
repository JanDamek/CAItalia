...
/**
 * DolniOdkazy filter form base class.
 *
 * @package    caitalia
 * @subpackage filter
 ...
 */
abstract class BaseDolniOdkazyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dolni_odkazy_filters[%s]');
