...
/**
 * Reklama_statistika filter form base class.
 *
 * @package    caitalia
 * @subpackage filter
 ...
 */
abstract class BaseReklama_statistikaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'from_ip'           => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      'reklama_id'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Reklama'), 'column' => 'id')),
      ...
      'from_ip'           => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('reklama_statistika_filters[%s]');
